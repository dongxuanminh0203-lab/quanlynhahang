...
public class TableDAO {
    ...
    public int insert(String name, int capacity) throws SQLException {
        ...
        try (Connection connection = DBHelper.getConnection();
            ...
            AuditLogger.log("CREATE_TABLE", "TABLE", null, "Tạo bàn: " + name);
            return result;
        }
    }
    ...
    public int update(int id, String name, int capacity) throws SQLException {
        ...
        try (Connection connection = DBHelper.getConnection();
            ...
            int result = statement.executeUpdate();
            AuditLogger.log("UPDATE_TABLE", "TABLE", id, "Cập nhật bàn: " + name);
            return result;
        }
    }
    ...
    public int delete(int id) throws SQLException {
        ...
        try (Connection connection = DBHelper.getConnection();
            ...
            int result = statement.executeUpdate();
            AuditLogger.log("DELETE_TABLE", "TABLE", id, "Xóa bàn");
            return result;
        }
    }

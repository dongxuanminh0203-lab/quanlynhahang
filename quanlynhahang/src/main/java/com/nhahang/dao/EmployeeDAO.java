...
public class EmployeeDAO {
    ...
    // =========================
        ...
        try (
            ...
            AuditLogger.log("CREATE_EMPLOYEE", "EMPLOYEE", employee.getId(), "Tạo nhân viên");
        }
    }
    ...
    // =========================
        ...
        try (
            ...
            statement.executeUpdate();
            AuditLogger.log("UPDATE_EMPLOYEE", "EMPLOYEE", employee.getId(), "Cập nhật nhân viên");
        }
    }
    ...
    public void delete(int employeeId)
        ...
        try (
            ...
            statement.executeUpdate();
            AuditLogger.log("DELETE_EMPLOYEE", "EMPLOYEE", employeeId, "Xóa nhân viên");
        }
    }

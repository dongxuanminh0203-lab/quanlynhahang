...
public class MainFrame extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        menuScroll.getViewport().setBackground(SIDEBAR);
        menuScroll.setBackground(SIDEBAR);
        ...
        btnStatistics.addActionListener(
                ...
                btnAudit.addActionListener(
                                e -> {
                                        if (PermissionUtil.canManageUsers(currentUser)) {
                                                setSelectedButton(btnAudit);
                                                showPanel(new AuditPanel());
                                        } else {
                                                showAccessDenied();
                                        }
                                }
